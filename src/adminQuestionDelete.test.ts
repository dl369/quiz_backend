import {
  ...
  requestClear, requestAdminQuestionDelete, requestAdminQuestionCreate
...
describe('adminQuizInfo', () => {
  describe('Error Tests', () => {
    test('Invalid token', () => {
      ...
      const questionDelete = requestAdminQuestionDelete(quiz.quizId, question.questionId, user.token + 'invalid');
    ...
    test('Invalid quizId', () => {
      ...
      const question = requestAdminQuestionCreate(quiz.quizId, user.token, questionBody).body;
      const questionDelete = requestAdminQuestionDelete(quiz.quizId + 1, question.questionId, user.token);
    ...
    test('Quiz not owned by user', () => {
      ...
      const question = requestAdminQuestionCreate(quiz.quizId, user.token, questionBody).body;
      const questionDelete = requestAdminQuestionDelete(quiz.quizId, question.questionId, user2.token);
    ...
    test('Invalid questionId', () => {
      ...
      const questionDelete = requestAdminQuestionDelete(quiz.quizId, 1, user.token);
  ...
  describe('Passing Tests', () => {
    test('Successful call', () => {
      ...
      const questionDelete = requestAdminQuestionDelete(quiz.quizId, question.questionId, user.token);
